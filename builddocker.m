...
% docker run --rm -e "DISPLAY=:57" -v /tmp/.X11-unix:/tmp/.X11-unix -v /rsrch1/ip/rmuthusivarajan/imaging/NFBS/Train_interpolation/preprocess/imgResized:/data -v /rsrch1/ip/rmuthusivarajan/imaging/NFBS/Train_interpolation:/model -v /home/fuentes:/out:rw brainsegmentation-standalone-app /data/resized_T1w_A00060372.nii.gz /model/fold_1-trainedDensenet3d.mat /model/test
